...
namespace _3DSExplorer.Modules
{
    ...
    public class CCIContext : IContext
    {
        ...
        {
            fs.SetLength((long)NcsdInfo.CCI_S_Trimmed_Size);
        }
        ...
        public void GetMinFW()
        {
            ...
            switch (Header.CVerTitleVersion)
            {
                ...
                default: MAJOR = Header.CVerTitleVersion / 1024; MINOR = (Header.CVerTitleVersion - 1024 * (Header.CVerTitleVersion / 1024)) / 0x10; break;
            }
